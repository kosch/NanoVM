...
// cpu related setup
#define ATMEGA16
#define NIBOBEE                // compiles some special code e.g. in uart.c
#define CLOCK F_CPU
...
#define CODESIZE 1024          // maximum java program size
#define HEAPSIZE 512           // only 1204 to use 8 bit heap entries...
