...
// nanovm/nibobee/drivers/*
#define NATIVE_CLASS_NIBOBEE_BOT             (NATIVE_CLASS_BASE+12)
#define NATIVE_CLASS_NIBOBEE_CLOCK           (NATIVE_CLASS_BASE+13)
#define NATIVE_CLASS_NIBOBEE_SENSOR          (NATIVE_CLASS_BASE+15)
#define NATIVE_CLASS_NIBOBEE_LEDS            (NATIVE_CLASS_BASE+19)
#define NATIVE_CLASS_NIBOBEE_LINEDETECTOR    (NATIVE_CLASS_BASE+21)
#define NATIVE_CLASS_NIBOBEE_MOTOR           (NATIVE_CLASS_BASE+22)
#define NATIVE_CLASS_NIBOBEE_WHEELENCODER    (NATIVE_CLASS_BASE+26)
