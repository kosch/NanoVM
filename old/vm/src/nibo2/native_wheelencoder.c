...
void native_nibo_wheelencoder_invoke(u08_t mref) {
  ...
  // JAVA: int getLeftInc()
    ...
    nvm_int_t val = (int16_t)(copro_ticks_l-last_ticks_l);
  ...
  // JAVA: int getRightInc()
    ...
    nvm_int_t val = (int16_t)(copro_ticks_r-last_ticks_r);
