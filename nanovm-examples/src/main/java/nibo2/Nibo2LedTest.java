...
class Nibo2LedTest {
  ...
  public static void main(String[] args) {
    ...
    while(true) {
      // test leds
      led(Leds.BACK_LEFT,   Leds.GREEN, 200);
      ...
      led(Leds.BACK_RIGHT,  Leds.GREEN, 200);

      
      led(Leds.BACK_LEFT,   Leds.ORANGE, 200);
      ...
      led(Leds.BACK_RIGHT,  Leds.ORANGE, 200);
    
      led(Leds.BACK_LEFT,   Leds.RED, 200);
      ...
      led(Leds.BACK_RIGHT,  Leds.RED, 200);
    
      led(Leds.BACK_LEFT,   Leds.OFF, 200);
      ...
      led(Leds.BACK_RIGHT,  Leds.OFF, 200);
    }
  }
}
